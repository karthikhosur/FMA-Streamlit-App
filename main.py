...
fig = px.scatter(df,x='tempo',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>Tempo Versus Popularity')
st.plotly_chart(fig)

fig = px.scatter(df,x='danceability',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>danceability Versus Popularity')
st.plotly_chart(fig)
fig = px.scatter(df,x='energy',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>energy Versus Popularity')
st.plotly_chart(fig)
fig = px.scatter(df,x='speechiness',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>speechiness Versus Popularity')
st.plotly_chart(fig)
fig = px.scatter(df,x='acousticness',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>acousticness Versus Popularity')
st.plotly_chart(fig)
fig = px.scatter(df,x='liveness',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>liveness Versus Popularity')
st.plotly_chart(fig)
fig = px.scatter(df,x='valence',y='song_hotttnesss',color='tempo',color_continuous_scale=px.colors.sequential.Plasma,template='plotly_dark',title='<b>valence Versus Popularity')
st.plotly_chart(fig)